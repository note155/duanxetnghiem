...
namespace Recruit.Client
{
    public class CustomAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        public void MarkUserAsAuthenticated(string? email, string? loaiacc)
        {
            var authenticatedUser = new ClaimsPrincipal(
                new ClaimsIdentity(new[]    
                    { 
                        new Claim("email", email ?? string.Empty),
                        new Claim("loaiacc", loaiacc ?? string.Empty)
        ...
        internal void NotifyAuthenticationStateChanged(Task<AuthenticationState> task)
        {
